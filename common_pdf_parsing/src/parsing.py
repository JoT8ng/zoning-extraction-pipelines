...
class Parsing:
    ...
    def extract_zoning_titles(text):
    ...
    def split_zoning_sections(matched_categories, text, zoning_categories):
    ...
    def onezoningsection_extractext(text, zoning_categories):
